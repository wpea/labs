            ...
            <div className="border rounded-lg lg:col-span-2 place-self-start w-full">
                <div className="p-4">
                    <div className="tracking-wide space-y-6">
                        <div className="font-bold text-sm tracking-tight">Completed Projects</div>
                    </div>
                </div>
                <div className="p-4 space-y-6 border-t rounded-bl-md rounded-br-md hover:bg-gray-100">
                    <div className="grid grid-cols-2 bg-green-600 hover:bg-green-700 p-3 px-4 rounded-md hover:bg-blue-green cursor-pointer">
                        ...
                        <div className="flex justify-self-end space-x-3">
                            <div className="text-2xs border border-green-500 rounded-md px-2 py-1 text-white font-medium uppercase">End date &bull; Mar 12th, 2022</div>
