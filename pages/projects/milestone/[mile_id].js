                  ...
                  <div className="md:justify-self-end md:self-start flex items-center space-x-2">
                    {task.status === "ongoing" ? (
                      <div
                        ...
                        className="text-2xs border items-center cursor-pointer hover:bg-stone-800 hover:border-none space-x-1 flex border-stone-500 rounded-md px-2 py-1 text-white font-medium uppercase"
                      >
                        <svg
                      ...
                      <div className="text-2xs items-center cursor-pointer bg-stone-800 hover:border-none space-x-1 flex rounded-md px-2 py-1 text-white font-medium uppercase">
                        <div>Completed</div>
                      </div>
                    )}
